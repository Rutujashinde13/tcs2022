...
public class ProcessPensionServiceTest {
	...
	{
		String token = "dummy";
		PensionerInput pensionerInput =  new PensionerInput(0, token, null, token, token);
		//new PensionerInput(420559429029l, "Parthik", LocalDate.of(1999, 12, 03), "BSDPS1495K", "self");
		
		PensionDetail pensionDetail =new PensionDetail(token, null, token, token, 0);
		//new PensionDetail("Parthik", LocalDate.of(1999, 12, 03), "BSDPS1495K", "self", 24400.0);
		
		PensionerDetail pensionerDetail = new PensionerDetail(0, token, null, token, 0, 0, token, token, token, token);
				//420559429029l, "Parthik", LocalDate.of(1999, 12, 03), "BSDPS1495K", 29000, 1200, "self", "SBI", "9029486523", "private");
